...
<head>
    ...
    <style>
        ...
        .deleted-button { background-color: #f57c00; }
        .deleted-button:hover { background-color: #ef6c00; }
        ...
        .btn-action.edit { background-color: #4CAF50; color: white; }
        .btn-action.delete { background-color: #f44336; color: white; }
        .btn-action.reactivate { background-color: #2196F3; color: white; }
...
<script>
    ...
    window.onclick = function(event) {
        if (event.target === document.getElementById("addPromotionModal")) closeModal();
